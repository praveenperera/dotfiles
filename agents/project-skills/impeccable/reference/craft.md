...
If the directory is empty (greenfield), don't pick a framework silently. Ask the user via Codex's structured user-input tool when available, with sensible defaults framed by the brief:
