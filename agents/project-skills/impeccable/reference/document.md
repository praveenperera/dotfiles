...
The following require creative input that cannot be auto-extracted. Group them into one structured user-input interaction:
...
Group into one structured user-input interaction. Options must be concrete.
