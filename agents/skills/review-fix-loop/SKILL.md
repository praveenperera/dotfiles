...
1. **Z.ai GLM 5.3 main loop:** request an evidence-backed review using the provider prompt. When it reports actionable findings, normalize and deduplicate them, run one fresh Luna Max fix pass, verify locally, and have GLM review the changed code again.
