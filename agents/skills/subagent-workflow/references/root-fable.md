...
Use [codex-native.md](codex-native.md) for Astra and Luna. Use [claude-cli.md](claude-cli.md) for Claude Agent-tool or CLI selection and [grok-cli.md](grok-cli.md) for Grok.
