...
fpath+=( "$HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-ellie-SLASH-atuin" )
source "$HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-ellie-SLASH-atuin/atuin.plugin.zsh"
