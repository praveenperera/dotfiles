...
values."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(atom-one-dark-theme,
                         monokai,
                         zenbun,
                         atom-one-dark
                         molokai
