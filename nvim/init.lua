...
local config = {
	...
	mappings = {
		n = {
			...
			["<leader>h5"] = { function() require("harpoon.ui").nav_file(5) end, desc = "Go to file 5" },
			["<leader>h6"] = { function() require("harpoon.ui").nav_file(6) end, desc = "Go to file 6" },
			["g1"] = { function() require("harpoon.ui").nav_file(1) end, desc = "Go to file 1" },
			["g2"] = { function() require("harpoon.ui").nav_file(2) end, desc = "Go to file 2" },
			["g3"] = { function() require("harpoon.ui").nav_file(3) end, desc = "Go to file 3" },
			["g4"] = { function() require("harpoon.ui").nav_file(4) end, desc = "Go to file 4" },
			["g5"] = { function() require("harpoon.ui").nav_file(5) end, desc = "Go to file 5" },
			["g6"] = { function() require("harpoon.ui").nav_file(6) end, desc = "Go to file 6" },
			-- quick save
